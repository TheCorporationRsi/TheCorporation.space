...
@scheduler.task("interval",id="parse_fund", minutes=20 , max_instances=1)
def get_funding_stats():
    ...
    with open('/home/cyberdreamer/website/corp/corporation/dashboard/pages/stats/temp_data.json', 'w') as outfile:
