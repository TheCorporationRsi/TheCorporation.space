...
class InfluenceChartWidget extends StatelessWidget {
  ...
  const InfluenceChartWidget({super.key, required this.category, required this.filter});
      ...
      if (filter == "All") {
        return [
          PieChartSectionData(
            ...
            value: stats.value.generalInfluence!.toDouble() < 1 ? 1 : stats.value.generalInfluence!.toDouble(),
            radius: 25,
            showTitle: false,
          ),
        ...
        final department_influence_only = department.influence!.toDouble() - department.divisions!.map((division) => division.influence!.toDouble()).reduce((a, b) => a + b);
        return [
          PieChartSectionData(
            color: backgroundColor,
            value: department_influence_only < 1 ? 1 : department_influence_only,
            radius: 25,
            showTitle: false,
          ),
          ...department.divisions!.asMap().entries.map((entry) {
            ...
            return PieChartSectionData(
              ...
              value: division.influence!.toDouble(),
