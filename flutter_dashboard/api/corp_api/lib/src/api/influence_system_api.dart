...
import 'package:corp_api/src/model/send_tribute400_response.dart';
...
class InfluenceSystemApi {
  ...
  Future<Response<void>> getInfluence({
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getProfile({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> getTributeHistory({
    required String type,
    ...
    final _path =
        r'/api/v0/influence_system/profile/tribute_history/{type}/{request}/{page}'
            ...
            .replaceAll(
                '{' r'page' '}',
                encodeQueryParameter(_serializers, page, const FullType(int))
                    .toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
