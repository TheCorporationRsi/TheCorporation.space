...
class InfluenceSystemApi {
  ...
  const InfluenceSystemApi(this._dio, this._serializers);

  /// Close an auction by ID
  ///
  ///
  /// Parameters:
  /// * [deleteAuctionRequest] - Auction ID to close
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [CloseAuction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CloseAuction200Response>> closeAuction({
    DeleteAuctionRequest? deleteAuctionRequest,
    ...
    final _path = r'/api/v0/influence_system/auction/close';
    ...
    try {
      const _type = FullType(DeleteAuctionRequest);
      _bodyData = deleteAuctionRequest == null
          ? null
          : _serializers.serialize(deleteAuctionRequest, specifiedType: _type);
    ...
    CloseAuction200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CloseAuction200Response),
            ) as CloseAuction200Response;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<CloseAuction200Response>(
      data: _responseData,
  ...
  ///
  /// Parameters:
  /// * [createAuctionRequest] - Auction creation data
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CreateAuction201Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CreateAuction201Response>> createAuction({
    ...
    final _path = r'/api/v0/influence_system/auction';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateAuctionRequest);
      _bodyData = createAuctionRequest == null
          ? null
          : _serializers.serialize(createAuctionRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    CreateAuction201Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(CreateAuction201Response),
            ) as CreateAuction201Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<CreateAuction201Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [deleteAuctionRequest] - Auction ID to delete
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [DeleteAuction200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DeleteAuction200Response>> deleteAuction({
    DeleteAuctionRequest? deleteAuctionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    DeleteAuction200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(DeleteAuction200Response),
            ) as DeleteAuction200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<DeleteAuction200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [title] - Department/Division title
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<GetProfile200Response>> getProfile({
    ...
    final _path = r'/api/v0/influence_system/profile';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetProfile200Response? _responseData;
    ...
    return Response<GetProfile200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GetRanks200ResponseInner>>> getRanks({
    ...
    BuiltList<GetRanks200ResponseInner>? _responseData;
    ...
    return Response<BuiltList<GetRanks200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GetTributeHistory200ResponseInner>>>
    ...
    BuiltList<GetTributeHistory200ResponseInner>? _responseData;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<ListAuctions200ResponseInner>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<ListAuctions200ResponseInner>>> listAuctions({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    BuiltList<ListAuctions200ResponseInner>? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(
                  BuiltList, [FullType(ListAuctions200ResponseInner)]),
            ) as BuiltList<ListAuctions200ResponseInner>;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<BuiltList<ListAuctions200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [placeBetRequest] - Bet information
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PlaceBet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PlaceBet200Response>> placeBet({
    ...
    final _path = r'/api/v0/influence_system/auction/bet';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PlaceBetRequest);
      _bodyData = placeBetRequest == null
          ? null
          : _serializers.serialize(placeBetRequest, specifiedType: _type);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(
          _dio.options,
    ...
    PlaceBet200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(PlaceBet200Response),
            ) as PlaceBet200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<PlaceBet200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [sendTributeRequest] - transfer information
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<GetRanks200ResponseInner>> sendTribute({
    ...
    final _path = r'/api/v0/influence_system/transfer';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetRanks200ResponseInner? _responseData;
    ...
    return Response<GetRanks200ResponseInner>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<void>> updateAccount({
    ...
    final _path = r'/api/v0/influence_system/update';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
