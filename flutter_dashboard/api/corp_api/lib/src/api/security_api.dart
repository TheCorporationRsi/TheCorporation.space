...
class SecurityApi {
  ...
  Future<Response<BuiltList<GetUsers200ResponseInner>>> getUsers({
    ...
    BuiltList<GetUsers200ResponseInner>? _responseData;
    ...
    return Response<BuiltList<GetUsers200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<ManualyVerifyUser200Response>> manualyVerifyUser({
    ...
    ManualyVerifyUser200Response? _responseData;
    ...
    return Response<ManualyVerifyUser200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
