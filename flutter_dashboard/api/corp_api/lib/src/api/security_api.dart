...
class SecurityApi {
  ...
  ///
  /// Parameters:
  /// * [changePasswordRequest] - registration information
  ...
  Future<Response<void>> changePassword({
    ...
    final _path = r'/api/v0/change_password';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [GetCookieExpiration200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetCookieExpiration200Response>> getCookieExpiration({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v0/cookie_expiration';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetCookieExpiration200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(GetCookieExpiration200Response),
            ) as GetCookieExpiration200Response;
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<GetCookieExpiration200Response>(
      data: _responseData,
  ...
  Future<Response<GetRSIToken200Response>> getRSIToken({
    ...
    final _path = r'/api/v0/RSI_token';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GetRSIToken200Response? _responseData;
    ...
    return Response<GetRSIToken200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> refreshToken({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v0/refresh_token';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [registerRequest] - registration information
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeCookie({
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v0/remove_cookie';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<VerifyRSIToken200Response>> verifyRSIToken({
    ...
    final _path = r'/api/v0/test_RSI_token';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    VerifyRSIToken200Response? _responseData;
    ...
    return Response<VerifyRSIToken200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
