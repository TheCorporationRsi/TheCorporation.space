...
class RSIStatsApi {
  ...
  const RSIStatsApi(this._dio, this._serializers);
  ...
  Future<Response<GetCurrentFunding200Response>> getCurrentFunding({
    ...
    final _path = r'/api/v0/current_funding';
    ...
    GetCurrentFunding200Response? _responseData;
    ...
    return Response<GetCurrentFunding200Response>(
      data: _responseData,
