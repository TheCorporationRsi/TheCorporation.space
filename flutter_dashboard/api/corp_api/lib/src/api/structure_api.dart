...
class StructureApi {
  ...
  const StructureApi(this._dio, this._serializers);
  ...
  Future<Response<AddUserRole200Response>> addUserRole({
    ...
    final _path = r'/api/v0/structure/profile/roles';
    ...
    AddUserRole200Response? _responseData;
    ...
    return Response<AddUserRole200Response>(
      data: _responseData,
  ...
  Future<Response<BuiltList<GetDivisions200ResponseInner>>> getDivisions({
    ...
    BuiltList<GetDivisions200ResponseInner>? _responseData;
    ...
    return Response<BuiltList<GetDivisions200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GetRoles200ResponseInner>>> getRoles({
    ...
    BuiltList<GetRoles200ResponseInner>? _responseData;
    ...
    return Response<BuiltList<GetRoles200ResponseInner>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<GetUserDepartments200ResponseInner>>>
    ...
    final _path = r'/api/v0/structure/profile/departments';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<GetUserDivisions200ResponseInner>>>
    ...
    final _path = r'/api/v0/structure/profile/divisions';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<GetUserProfile200Response>> getUserProfile({
    ...
    final _path = r'/api/v0/structure/profile';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [deleteDivisionRequest] - Division title
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [JoinDivision200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JoinDivision200Response>> joinDivision({
    ...
    final _path = r'/api/v0/structure/divisions/join';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    JoinDivision200Response? _responseData;
    ...
    try {
      ...
      _responseData = rawResponse == null
          ...
          : _serializers.deserialize(
              rawResponse,
              specifiedType: const FullType(JoinDivision200Response),
            ) as JoinDivision200Response;
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _response.requestOptions,
        response: _response,
    ...
    return Response<JoinDivision200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [JoinDivision200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<JoinDivision200Response>> leaveDivision({
    DeleteDivisionRequest? deleteDivisionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v0/structure/divisions/leave';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<RemoveUserRole200Response>> removeUserRole({
    ...
    RemoveUserRole200Response? _responseData;
