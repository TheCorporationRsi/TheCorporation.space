...
class InformationApi {
  ...
  const InformationApi(this._dio, this._serializers);
  ...
  Future<Response<BuiltList<GetCorporateers200ResponseInner>>> getCorporateers({
    ...
    final _path = r'/api/v0/corporateers';
    ...
    BuiltList<GetCorporateers200ResponseInner>? _responseData;
    ...
    return Response<BuiltList<GetCorporateers200ResponseInner>>(
      data: _responseData,
